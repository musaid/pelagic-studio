...
### No direct MSP data exists for any sport fishing grouper
...
### Derivation of coral grouper values

- **SWS2 (440 nm):** General percomorph SWS2 range is 397-482 nm. For reef-dwelling Epinephelidae, ~440 nm is consistent with the SWS2 class replacing UV sensitivity in adults. Weight 0.30 reflects single cones being less abundant.
- **RH2 (515 nm):** With 3-5 RH2 paralogs in Epinephelus, the effective RH2 sensitivity likely covers a range. 515 nm represents the dominant RH2 channel. This is slightly shorter than snapper (520 nm), reflecting the grouper's darker reef-cave habitat where blue-green light dominates. Weight 0.65 reflects twin cones being the dominant photoreceptor.
- **LWS (555 nm):** The ERG photopic peak at ~560 nm strongly supports an LWS cone. 555 nm is the estimated in vivo peak, consistent with the percomorph LWS range (501-573 nm). Weight 0.55 reflects LWS being the secondary double cone member.
- **Rods (500 nm):** Directly supported by the ERG scotopic peak at ~500 nm. Consistent with reef fish rod pigments (Schweikert & Caves 2018).
...
- At depth (>30m in reef structures), greens and blues dominate; reds are lost to water attenuation regardless of the fish's visual capacity
- The low-light ambush hunting style means contrast and flash may matter more than color at depth
