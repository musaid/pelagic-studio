      ...
      <div className="mx-auto max-w-3xl px-4 py-16">
        ...
        <div className="space-y-12">
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-4 rounded-xl border border-blue-900/40 bg-[#0d1426] p-6">
              <p className="text-sm leading-relaxed text-slate-400">
                The primary source for this simulation is Loew, McFarland &
                Margulies (2002), which characterized the visual pigments of
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-0.5 text-xs text-slate-500">
                      The dominant channel. These are the primary brightness and
                      motion detectors — the most important photoreceptors in
                      the retina.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-0.5 text-xs text-slate-500">
                      YFT have no red-sensitive photoreceptors. Red, orange, and
                      most yellow appear as dark grey or black.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-4 text-sm leading-relaxed text-slate-400">
              ...
              <ol className="list-inside list-decimal space-y-3 pl-2">
                ...
                <li>
                  ...
                  wavelengths are absorbed ~21× faster than blue at the selected
                  depth.
                </li>
                <li>
                  <span className="text-slate-300">
                ...
                <li>
                  ...
                  by each cone type's relative abundance in the retina (twin
                  cones dominant at 0.85, single cones secondary at 0.35).
                </li>
                <li>
                  <span className="text-slate-300">
                    Reconstruct a displayable image
                  </span>{' '}
                  in the tuna's perceptual color space — necessarily
                  blue-dominant, with reds collapsed to near-black and
                  blues/violets preserved.
                </li>
              </ol>
