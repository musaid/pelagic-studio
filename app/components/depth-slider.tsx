...
export function DepthSlider({ depth, onChange, disabled = false }: DepthSliderProps) {
        ...
        <div className="relative mt-2 flex justify-between">
          {DEPTH_MARKS.map((mark) => (
            <button
              ...
              disabled={disabled}
              className={[
                "text-xs transition-colors duration-150 cursor-pointer",
                depth === mark ? "text-blue-400 font-semibold" : "text-slate-600 hover:text-slate-400",
